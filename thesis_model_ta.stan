...
// MAIN MODEL
  ...
  int<lower=0> abund[ncounts];   // Total abundance
...
// OBSERVER SUB-MODEL --------------------
  ...
  // observed data
  int<lower=0> abund_obs[ncounts_obs];   // Total abundance at a route
...
// MAIN MODEL 
 ...
 sigma_n ~ student_t(20, 0, 1); // Prior for scale parameter for noise
