...
t.sitesByYear <- sitesByYear[which(sitesByYear$Count >= 7),]
t.list <- sitesByYear$RouteNumber
...
s7 <- s.forest[which(s.forest$X2018 <= 38 & s.forest$X2018 >= 14 & s.forest$ECOZONE == 14),]
s7$Region <- rep(7)
l7 <- s7$RouteNumber
...
s11 <- s.forest[which(s.forest$X2018 <= 38 & s.forest$X2018 >= 14 & s.forest$ECOZONE == 14),]
s11$Region <- rep(11)
l11 <- s11$RouteNumber

# temporal = route 11614
s12 <- s.forest[which(s.forest$X2018 <= 76 & s.forest$X2018 >= 34 & s.forest$ECOZONE == 13),]
s12$Region <- rep(12)
l12 <- s12$RouteNumber
...
s20 <- s.forest[which(s.forest$X2018 <= 73 & s.forest$X2018 >= 44 & s.forest$ECOZONE == 6),]
s20$Region <- rep(20)
l20 <- s20$RouteNumber

# temporal = route 76439
s21 <- s.forest[which(s.forest$X2018 <= 81 & s.forest$X2018 >= 56 & s.forest$ECOZONE == 6),]
s21$Region <- rep(21)
l21 <- s21$RouteNumber


### dataframe of spatial lists for each temporal site
s.data <- data.table(l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20,l21)
...
write.csv(spatial_merge,"spatialdataset_NOV9.csv")
...
write.csv(temporal, "temporaldataset_NOV9.csv")
