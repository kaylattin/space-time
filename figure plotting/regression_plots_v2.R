...
d <- read.csv("~/space-time/final datasets/TA2_mean_forest/ta_forest_FINALsubset.csv")
d$Region <- as.integer(as.factor(d$ref))
d$Obs_ID <- as.integer(as.factor(d$ObsN))
d$Cover_std <- as.vector(scale(d$Forest.cover))
...
pdf("ta_forest_regression.pdf", height = 10)
...
d <- read.csv("~/space-time/final datasets/TA3_mean_open/ta_open_FINALsubset.csv")
d$Region <- as.integer(as.factor(d$ref))
d$Obs_ID <- as.integer(as.factor(d$ObsN))
d$Cover_std <- as.vector(scale(d$Forest.cover))
...
pdf("ta_open_regression.pdf", height = 10)
...
d <- read.csv("~/space-time/final datasets/SR2_mean_forest/richness_forest_FINALsubset.csv")
d$Region <- as.integer(as.factor(d$ref))
d$Obs_ID <- as.integer(as.factor(d$ObsN))
d$Cover_std <- as.vector(scale(d$Forest.cover))
...
pdf("richness_forest_regression.pdf", height = 10)
...
#### MEAN RICHNESS - OPEN ######
d <- read.csv("~/space-time/final datasets/SR3_mean_open/richness_open_FINALsubset.csv")
d$Region <- as.integer(as.factor(d$ref))
d$Obs_ID <- as.integer(as.factor(d$ObsN))
d$Cover_std <- as.vector(scale(d$Forest.cover))
...
pdf("richness_open_regression.pdf", height = 10)
...
d <- read.csv("~/space-time/final datasets/evenness_dataset_total_FINAL.csv")
d$Region <- as.integer(as.factor(d$ref))
d$Obs_ID <- as.integer(as.factor(d$ObsN))
d$Cover_std <- as.vector(scale(d$Forest.cover))

load("~/space-time/final datasets/evenness_total.RData")
draws <- rstan::extract(stanfit, pars = c("a", "b_space", "b_time", "observer"))


pdf("evenness_total_plots.pdf", height = 10)
