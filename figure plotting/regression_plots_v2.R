...
d <- read.csv("~/space-time/final datasets/tabundance_dataset_FINAL.csv")
...
pdf("ta_total_plots.pdf", height = 10)
...
d <- read.csv("~/space-time/final datasets/TA2_mean_forest/ta_dataset_forest_FINAL.csv")
d$Region <- as.integer(as.factor(d$ref))
d$Obs_ID <- as.integer(as.factor(d$ObsN))
d$Cover_std <- as.vector(scale(d$Forest.cover))
...
pdf("mean_ta_forest_plots.pdf", height = 10)
...
d <- read.csv("~/space-time/final datasets/TA3_mean_open/ta_dataset_open_FINAL.csv")
d$Region <- as.integer(as.factor(d$ref))
d$Obs_ID <- as.integer(as.factor(d$ObsN))
d$Cover_std <- as.vector(scale(d$Forest.cover))
...
pdf("mean_ta_open_plots.pdf", height = 10)
...
d <- read.csv("~/space-time/final datasets/SR1_total/total_richness_dataset_FINAL.csv")
d$Region <- as.integer(as.factor(d$ref))
d$Obs_ID <- as.integer(as.factor(d$ObsN))
d$Cover_std <- as.vector(scale(d$Forest.cover))
...
pdf("total_richness_plots.pdf", height = 10)
...
d <- read.csv("~/space-time/final datasets/SR2_mean_forest/richness_dataset_forest_FINALV2.csv")
d$Region <- as.integer(as.factor(d$ref))
d$Obs_ID <- as.integer(as.factor(d$ObsN))
d$Cover_std <- as.vector(scale(d$Forest.cover))
...
pdf("mean_richness_forest_plots.pdf", height = 10)
...
#### MEAN RICHNESS - OPEN ######
d <- read.csv("~/space-time/final datasets/SR3_mean_open/richness_dataset_open_only_FINAL.csv")
d$Region <- as.integer(as.factor(d$ref))
d$Obs_ID <- as.integer(as.factor(d$ObsN))
d$Cover_std <- as.vector(scale(d$Forest.cover))
...
pdf("mean_richness_open_plots.pdf", height = 10)
