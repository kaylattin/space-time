...
forestcover <- select(forestcover, -c(4:20))
...
## Then, for each temporal site 2000 to 2018 range, after rounding to nearest 1%, and giving an "sd" range of + or - 2%,
...
# temporal = route 4141
s3 <- s.forest[which(s.forest$X2018 <= 62 & s.forest$X2018 >= 24 & s.forest$ECOZONE == 9),]
p <- c("Alberta", "British Columbia", "Saskatchewan") 
...
s5 <- s.forest[which(s.forest$X2018 <= 72 & s.forest$X2018 >= 41 & s.forest$ECOZONE == 14),]
p <- c("Alberta", "British Columbia") 
...
s6 <- s.forest[which(s.forest$X2018 <= 64 & s.forest$X2018 >= 32 & s.forest$ECOZONE == 14),]
p <- c("Alberta", "British Columbia") 
...
s7 <- s.forest[which(s.forest$X2018 <= 38 & s.forest$X2018 >= 13 & s.forest$ECOZONE == 14),]
p <- c("Alberta", "British Columbia") 
...
s8 <- s.forest[which(s.forest$X2018 <= 75 & s.forest$X2018 >= 43 & s.forest$ECOZONE == 14),]
p <- c("Alberta", "British Columbia") 
...
s9 <- s.forest[which(s.forest$X2018 <= 72 & s.forest$X2018 >= 10 & s.forest$ECOZONE == 14),]
p <- c("Alberta", "British Columbia") 
...
s10 <- s.forest[which(s.forest$X2018 <= 70 & s.forest$X2018 >= 40 & s.forest$ECOZONE == 13),]
p <- c("Alberta", "British Columbia") 
...
s11 <- s.forest[which(s.forest$X2018 <= 76 & s.forest$X2018 >= 40 & s.forest$ECOZONE == 14),]
p <- c("Alberta", "British Columbia") 
...
s12 <- s.forest[which(s.forest$X2018 <= 61 & s.forest$X2018 >= 34 & s.forest$ECOZONE == 13),]
p <- c("Alberta", "British Columbia") 
...
s13 <- s.forest[which(s.forest$X2018 <= 76 & s.forest$X2018 >= 50 & s.forest$ECOZONE == 6),]
...
s14 <- s.forest[which(s.forest$X2018 <= 66 & s.forest$X2018 >= 33 & s.forest$ECOZONE == 6),]
p <- c("Manitoba", "Saskatchewan", "Ontario") 
...
s15 <- s.forest[which(s.forest$X2018 <= 79 & s.forest$X2018 >= 54 & s.forest$ECOZONE == 7),]
...
s16 <- s.forest[which(s.forest$X2018 <= 56 & s.forest$X2018 >= 25 & s.forest$ECOZONE == 6),]
...
s17 <- s.forest[which(s.forest$X2018 <= 78 & s.forest$X2018 >= 54 & s.forest$ECOZONE == 6),]
p <- c("Manitoba", "Ontario", "Quebec")
...
s18 <- s.forest[which(s.forest$X2018 <= 66 & s.forest$X2018 >= 40 & s.forest$ECOZONE == 6),]
p <- c("Manitoba", "Ontario", "Quebec")
...
s19 <- s.forest[which(s.forest$X2018 <= 85 & s.forest$X2018 >= 60 & s.forest$ECOZONE == 6),]
...
s20 <- s.forest[which(s.forest$X2018 <= 80 & s.forest$X2018 >= 56 & s.forest$ECOZONE == 6),]
p <- c("Quebec", "Ontario", "Newfoundland & Labrador", "New Brunswick")
...
write.csv(s.data,"spatialSiteList_check_DEC4.csv") # needs some post-processing in excel to remove recycling in columns
...
write.csv(spatial_merge,"spatialdataset_DEC4_D.csv")
...
write.csv(temporal, "temporaldataset_DEC4.csv")
